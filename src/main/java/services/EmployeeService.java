...
public class EmployeeService extends ServiceBase{
    ...
    public EmployeeView findOne(String code, String plainPass, String pepper) {
        ...
        try {
            ...
            // 社員番号とハッシュ化済パスワードを条件に未削除の従業員を1権取得する
    ...
    /**
     * 画面から入力された従業員の登録内容を元にデータ一件を作成し、従業員テーブルに登録する
    ...
    /**
     * idを条件にデータを一見取得し、Employeeのインスタンスで返却する
     * @param id
     * @return 取得データのインスタンス
     */
